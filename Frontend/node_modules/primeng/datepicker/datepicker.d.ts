 ...
 * @group Components
 */
export declare class DatePicker extends BaseComponent implements OnInit, OnDestroy, ControlValueAccessor {
    private zone;
