 ...
 * @group Components
 */
export declare class Carousel extends BaseComponent implements AfterContentInit {
    el: ElementRef;
    zone: NgZone;
    /**
     ...
     * @group Templates
     */
    previousicon: TemplateRef<any> | undefined;
    /**
     * Template for the next button icon.
     * @group Templates
     */
    nexticon: TemplateRef<any> | undefined;
    window: Window;
