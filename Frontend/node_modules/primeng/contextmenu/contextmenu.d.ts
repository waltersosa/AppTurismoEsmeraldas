...
export declare class ContextMenuSub extends BaseComponent {
 ...
 * @group Components
 */
export declare class ContextMenu extends BaseComponent implements OnInit, OnDestroy {
     ...
     * @group Templates
     */
    submenuicon: TemplateRef<any> | undefined;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ContextMenu, "p-contextMenu, p-contextmenu, p-context-menu", never, { "model": { "alias": "model"; "required": false; }; "triggerEvent": { "alias": "triggerEvent"; "required": false; }; "target": { "alias": "target"; "required": false; }; "global": { "alias": "global"; "required": false; }; "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; "appendTo": { "alias": "appendTo"; "required": false; }; "autoZIndex": { "alias": "autoZIndex"; "required": false; }; "baseZIndex": { "alias": "baseZIndex"; "required": false; }; "id": { "alias": "id"; "required": false; }; "breakpoint": { "alias": "breakpoint"; "required": false; }; "ariaLabel": { "alias": "ariaLabel"; "required": false; }; "ariaLabelledBy": { "alias": "ariaLabelledBy"; "required": false; }; "pressDelay": { "alias": "pressDelay"; "required": false; }; }, { "onShow": "onShow"; "onHide": "onHide"; }, ["itemTemplate", "submenuicon"], never, true, never>;
