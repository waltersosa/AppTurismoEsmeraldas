import { AfterViewInit, ElementRef, NgZone, OnDestroy, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class ScrollPanel extends BaseComponent implements AfterViewInit, OnDestroy {
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ScrollPanel, "p-scroll-panel, p-scrollPanel, p-scrollpanel", never, { "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; "step": { "alias": "step"; "required": false; }; }, {}, ["contentTemplate"], ["*"], true, never>;
