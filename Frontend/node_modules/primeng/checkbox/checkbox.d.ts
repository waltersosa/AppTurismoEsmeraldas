import { ElementRef, EventEmitter, SimpleChanges, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class Checkbox extends BaseComponent implements ControlValueAccessor {
    /**
