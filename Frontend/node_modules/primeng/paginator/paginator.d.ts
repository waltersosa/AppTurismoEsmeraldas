 ...
 * @group Components
 */
export declare class Paginator extends BaseComponent implements OnInit, OnChanges {
    /**
     ...
     * @group Templates
     */
    dropdownicon: Nullable<TemplateRef<any>>;
    /**
     * Template for the first page link icon.
     * @group Templates
     */
    firstpagelinkicon: Nullable<TemplateRef<any>>;
    /**
     * Template for the previous page link icon.
     * @group Templates
     */
    previouspagelinkicon: Nullable<TemplateRef<any>>;
    /**
     * Template for the last page link icon.
     * @group Templates
     */
    lastpagelinkicon: Nullable<TemplateRef<any>>;
    /**
     * Template for the next page link icon.
     * @group Templates
     */
    nextpagelinkicon: Nullable<TemplateRef<any>>;
