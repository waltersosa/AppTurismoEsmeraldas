...
import { DoCheck, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, PipeTransform, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class Password extends BaseComponent implements OnInit {
    /**
