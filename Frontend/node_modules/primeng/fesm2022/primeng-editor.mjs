...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Editor, { className: "Editor", filePath: "editor.ts", lineNumber: 81 }); })();
class EditorModule {
