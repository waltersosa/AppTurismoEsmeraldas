...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DynamicDialogComponent, { className: "DynamicDialogComponent", filePath: "dynamicdialog.ts", lineNumber: 114 }); })();
class DynamicDialog {
