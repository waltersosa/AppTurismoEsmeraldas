...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MenubarSub, { className: "MenubarSub", filePath: "menubar.ts", lineNumber: 208 }); })();
/**
 * Menubar is a horizontal menu component.
 * @group Components
 */
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Menubar, { className: "Menubar", filePath: "menubar.ts", lineNumber: 416 }); })();
class MenubarModule {
