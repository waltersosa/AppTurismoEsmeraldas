...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(SelectItem, { className: "SelectItem", filePath: "select.ts", lineNumber: 104 }); })();
/**
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Select, { className: "Select", filePath: "select.ts", lineNumber: 378 }); })();
class SelectModule {
