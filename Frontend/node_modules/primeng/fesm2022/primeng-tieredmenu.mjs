...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TieredMenuSub, { className: "TieredMenuSub", filePath: "tieredmenu.ts", lineNumber: 193 }); })();
/**
 * TieredMenu displays submenus in nested overlays.
 * @group Components
 */
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(TieredMenu, { className: "TieredMenu", filePath: "tieredmenu.ts", lineNumber: 397 }); })();
