...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Chip, { className: "Chip", filePath: "chip.ts", lineNumber: 48 }); })();
class ChipModule {
