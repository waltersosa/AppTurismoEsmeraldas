...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MultiSelectItem, { className: "MultiSelectItem", filePath: "multiselect.ts", lineNumber: 114 }); })();
// @ts-ignore
/**
 * MultiSelect is used to select multiple items from a collection.
 * @group Components
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MultiSelect, { className: "MultiSelect", filePath: "multiselect.ts", lineNumber: 434 }); })();
