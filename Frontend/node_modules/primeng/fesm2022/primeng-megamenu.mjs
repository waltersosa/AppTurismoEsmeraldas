...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MegaMenuSub, { className: "MegaMenuSub", filePath: "megamenu.ts", lineNumber: 200 }); })();
/**
 * MegaMenu is navigation component that displays submenus together.
 * @group Components
 */
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MegaMenu, { className: "MegaMenu", filePath: "megamenu.ts", lineNumber: 450 }); })();
