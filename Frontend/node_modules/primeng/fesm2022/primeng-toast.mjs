...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(ToastItem, { className: "ToastItem", filePath: "toast.ts", lineNumber: 139 }); })();
/**
 * Toast is used to display messages in an overlay.
 * @group Components
 */
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(Toast, { className: "Toast", filePath: "toast.ts", lineNumber: 260 }); })();
class ToastModule {
