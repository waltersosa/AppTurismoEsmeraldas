 ...
 * @group Components
 */
export declare class Toolbar extends BaseComponent implements BlockableUI {
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Toolbar, "p-toolbar", never, { "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; "ariaLabelledBy": { "alias": "ariaLabelledBy"; "required": false; }; }, {}, ["startTemplate", "endTemplate", "centerTemplate"], ["*"], true, never>;
}
