import { AfterContentInit, InputSignal, InputSignalWithTransform, ModelSignal, TemplateRef } from '@angular/core';
...
export declare class Step extends BaseComponent implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<Step, "p-step", never, { "value": { "alias": "value"; "required": false; "isSignal": true; }; "disabled": { "alias": "disabled"; "required": false; "isSignal": true; }; }, { "value": "valueChange"; }, ["content"], ["*"], true, never>;
}
/**
...
export declare class StepPanel extends BaseComponent implements AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StepPanel, "p-step-panel", never, { "value": { "alias": "value"; "required": false; "isSignal": true; }; }, { "value": "valueChange"; }, ["contentTemplate"], never, true, never>;
}
