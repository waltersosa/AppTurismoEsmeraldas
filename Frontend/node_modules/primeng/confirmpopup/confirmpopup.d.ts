...
import { AfterContentInit, ChangeDetectorRef, ElementRef, OnDestroy, Renderer2, TemplateRef } from '@angular/core';
import { Confirmation, ConfirmationService, OverlayService } from 'primeng/api';
 ...
 * @group Components
 */
export declare class ConfirmPopup extends BaseComponent implements AfterContentInit, OnDestroy {
    el: ElementRef;
    ...
    accepticon: Nullable<TemplateRef<any>>;
    rejecticon: Nullable<TemplateRef<any>>;
