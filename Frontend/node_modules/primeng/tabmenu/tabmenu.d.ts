import { AfterViewChecked, AfterViewInit, ElementRef, EventEmitter, OnDestroy, QueryList, TemplateRef } from '@angular/core';
 ...
 * @group Components
 */
export declare class TabMenu extends BaseComponent implements AfterViewInit, AfterViewChecked, OnDestroy {
    /**
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<TabMenu, "p-tabMenu, p-tabmenu", never, { "model": { "alias": "model"; "required": false; }; "activeItem": { "alias": "activeItem"; "required": false; }; "scrollable": { "alias": "scrollable"; "required": false; }; "popup": { "alias": "popup"; "required": false; }; "style": { "alias": "style"; "required": false; }; "styleClass": { "alias": "styleClass"; "required": false; }; "ariaLabel": { "alias": "ariaLabel"; "required": false; }; "ariaLabelledBy": { "alias": "ariaLabelledBy"; "required": false; }; }, { "activeItemChange": "activeItemChange"; }, ["itemTemplate", "previousiconTemplate", "nexticonTemplate"], never, true, never>;
