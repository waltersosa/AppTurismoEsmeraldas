...
import { AfterViewChecked, AfterViewInit, ElementRef, EventEmitter, NgZone, OnInit, Signal, TemplateRef } from '@angular/core';
import { ControlValueAccessor } from '@angular/forms';
import { FilterService, OverlayOptions, ScrollerOptions } from 'primeng/api';
 ...
 * @group Components
 */
export declare class Select extends BaseComponent implements OnInit, AfterViewInit, AfterViewChecked, ControlValueAccessor {
    zone: NgZone;
