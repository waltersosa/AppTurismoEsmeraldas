 ...
 * @group Components
 */
export declare class CascadeSelect extends BaseComponent implements OnInit {
     ...
     * @group Templates
     */
    loadingicon: Nullable<TemplateRef<any>>;
    /**
