...
export declare class PanelMenuSub extends BaseComponent {
...
export declare class PanelMenuList extends BaseComponent implements OnChanges {
    panelId: string | undefined;
    id: string | undefined;
    items: any[];
    itemTemplate: TemplateRef<any> | undefined;
 ...
 * @group Components
 */
export declare class PanelMenu extends BaseComponent implements AfterContentInit {
    /**
