...
export declare class InputNumber extends BaseComponent implements OnInit, AfterContentInit, OnChanges, ControlValueAccessor {
     ...
     * @group Templates
     */
    incrementbuttonicon: Nullable<TemplateRef<any>>;
    /**
     * Template of the decrement button icon.
     * @group Templates
     */
    decrementbuttonicon: Nullable<TemplateRef<any>>;
