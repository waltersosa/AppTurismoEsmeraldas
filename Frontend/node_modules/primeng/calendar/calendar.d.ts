 ...
 * @group Components
 */
export declare class Calendar extends BaseComponent implements OnInit, OnDestroy, ControlValueAccessor {
    private zone;
     ...
     * @group Templates
     */
    header: Nullable<TemplateRef<any>>;
    /**
     ...
     * @group Templates
     */
    disabledDate: Nullable<TemplateRef<any>>;
    /**
     * Custom template for decade view.
     * @group Templates
     */
    decade: Nullable<TemplateRef<any>>;
    /**
     * Custom template for previous month icon.
     * @group Templates
     */
    previousicon: Nullable<TemplateRef<any>>;
    /**
     * Custom template for next month icon.
     * @group Templates
     */
    nexticon: Nullable<TemplateRef<any>>;
    /**
     * Custom template for trigger icon.
     * @group Templates
     */
    triggericon: Nullable<TemplateRef<any>>;
    /**
     * Custom template for clear icon.
     * @group Templates
     */
    clearicon: Nullable<TemplateRef<any>>;
    /**
     * Custom template for decrement icon.
     * @group Templates
     */
    decrementicon: Nullable<TemplateRef<any>>;
    /**
     * Custom template for increment icon.
     * @group Templates
     */
    incrementicon: Nullable<TemplateRef<any>>;
    /**
     * Custom template for input icon.
     * @group Templates
     */
    inputicon: Nullable<TemplateRef<any>>;
